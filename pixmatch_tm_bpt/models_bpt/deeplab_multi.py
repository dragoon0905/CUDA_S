...
class ResNetMulti(nn.Module):
    ...
    def TM_params(self,target_list):
        b=[]
        for i in target_list:
            TM_name1 = 'TM' + str(i) + '_1'
            TM_name2 = 'TM' + str(i) + '_2'
    ...
    def optim_parameters(self, cfg,target_list):
        # if cfg.from_scratch:
        ...
        if self.tm:
            optim_parameters += [{'params': self.TM_params(target_list), 'lr': 10 * cfg.opt.learning_rate}]
